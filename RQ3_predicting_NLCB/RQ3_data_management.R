...
# load all data
derived_data <- list.files(path = "Z:/Documents/Data/2023-12-06",
...
baseline_data_table1 <- left_join(
  ...
  select(baseline_cr, patientId, country, dateOfBirth, height = E1_F4_height, 
         ...
         ecog = E1_F4_ecogstatus, treatmentline = E1_F29_trt_line, 
         RT = E1_F29_PalRT, ST = E1_F29_mCRPCsystemicTherapy)) %>%
